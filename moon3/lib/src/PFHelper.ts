...
namespace ha.pf {
    export class PFHelper {
        ...
        private ruteJalan: [number, number][] = [];
        ...
        private _updateArahCallBack: (() => void) | undefined = undefined;
        ...
        start(data: [number, number][]): void {
            if (data.length == 0) {
                throw new Error('no route to process');
            }
        ...
        public get updateArahCallBack(): (() => void) | undefined {
            return this._updateArahCallBack;
        }
        public set updateArahCallBack(value: (() => void) | undefined) {
