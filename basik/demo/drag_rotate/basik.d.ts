...
declare function LoadSound(url: string): HTMLAudioElement;
declare function PlaySound(s: HTMLAudioElement): void;
declare function LastSound(): HTMLAudioElement;
...
declare function Canvas(): HTMLCanvasElement;
declare function ClearArea(x: number, y: number, w: number, h: number): void;
declare function Graphics(w?: number, h?: number, canvas?: HTMLCanvasElement, mode?: number): void;
declare function Cls(x?: number, y?: number, w?: number, h?: number): void;
...
declare function Line(Ax: number, Ay: number, Bx: number, By: number): void;
declare function Rect(x1: number, y1: number, x2: number, y2: number): void;
...
declare function MouseDraggedX(btn?: number): number;
declare function MouseDraggedY(btn?: number): number;
...
declare function AngleDist(angleS: number, angleT: number, min?: boolean): number;
...
declare function CopyFromCanvas(img: Basik.Image, x: number, y: number): void;
...
declare const Align: typeof Basik.Teks.Align;
