...
copy ..\build\basik.js demo\dasar\drag_rotasi\lib
copy ..\build\basik.js demo\dasar\keyboard\lib
copy ..\build\basik.js demo\dasar\mouse\lib
copy ..\build\basik.js demo\dasar\muat_image\lib
copy ..\build\basik.js demo\dasar\rotate_remote\lib
