...
(function (Basik) {
    class Graphic {
        ...
        static backupWarna() {
            Basik.G.warnaBackup.b = Basik.G.biru;
            Basik.G.warnaBackup.g = Basik.G.hijau;
            Basik.G.warnaBackup.r = Basik.G.merah;
            Basik.G.warnaBackup.t = Basik.G.transparan;
        }
        static restoreColor() {
            Basik.G.biru = Basik.G.warnaBackup.b;
            Basik.G.hijau = Basik.G.warnaBackup.g;
            Basik.G.merah = Basik.G.warnaBackup.r;
            Basik.G.transparan = Basik.G.warnaBackup.t;
            Basik.G.updateStyleWarna();
        }
        ...
        static NoColor() {
            Basik.G.context.strokeStyle = 'none';
        }
        static updateStyleWarna() {
            Basik.G.context.fillStyle = `rgba(${Basik.G.merah}, ${Basik.G.hijau}, ${Basik.G.biru}, ${Basik.G.transparan})`;
        }
...
(function (Basik) {
    class ImgImpl {
        ...
        static PositionImagePolar(img, angle, jarak, x2, y2, skalaX = 1, skalaY = 1, tilt = 0) {
            ...
            p.x *= skalaX;
            p.x += x2;
            Basik.Tf.rotateRel(p.x, p.y, x2, y2, tilt);
            p.x = Basik.Tf.lastX;
            p.y = Basik.Tf.lastY;
            img.x = p.x;
            img.y = p.y;
        ...
        static AmbilPiksel(x = 0, y = 0) {
            try {
                ...
                Basik.G.biru = data[2];
                Basik.G.transparan = data[3];
                Basik.G.FillColor(Basik.G.merah, Basik.G.hijau, Basik.G.biru, Basik.G.transparan);
                return hasil;
            }
            catch (e) {
            }
...
(function (Basik) {
    class Img {
        ...
        static DrawImageXY(img, x, y, frame) {
            Basik.Ip.DrawImageXY(img, x, y, frame);
        }
        static PositionImagePolar(img, angle, jarak, x2, y2, skalaX = 1, skalaY = 1, tilt = 0) {
...
(function (Basik) {
    class SprDep {
        ...
        static ResizeImage(s, w, h) {
            Basik.Ip.ukuran(s, w, h);
        }
        static PositionImageXY(img, x = 0, y = 0) {
            img.x = x;
            img.y = y;
        }
        ...
        static TabrakanXY(spr, x1, y1, spr2, x2, y2) {
            return Basik.Ip.tabrakan(spr, x1, y1, spr2, x2, y2);
        }
        ...
        static Panjang(s, pj) {
            return Basik.Ip.panjang(s, pj);
        }
        static Lebar(s, lb) {
            return Basik.Ip.lebar(s, lb);
        }
        ...
        static Rotasi(s, sudut) {
            ...
            return Basik.Tf.normalizeDeg(s.rotasi);
        }
    }
    Basik.SprDep = SprDep;
})(Basik || (Basik = {}));
...
function StrokeColor(r = 0, g = 0, b = 0, a = 100) {
...
function Kotak(x1, y1, x2, y2, isi = false, garis = true, rotasi = 0) {
    let ctx = G.context;
    rotasi;
    if (isi) {
...
function Oval(x = 0, y = 0, radius, skalaX = 1, skalaY = .5, rotasi = 0) {
    let ctx = G.context;
    ctx.save();
    ctx.translate(x, y);
